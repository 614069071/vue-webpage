			...
			<div class="login-main">
				<el-form ref="loginForm" :model="loginFormData" :rules="rules" @submit.native.prevent>
					<el-form-item class="input-item" prop="password" :error="errorMessage">
						<el-input type="password" maxlength="15" autocomplete="off" placeholder="请输入密码" v-model.trim="loginFormData.password" @keyup.enter="loginSubmit" :validate-event="false"></el-input>
					</el-form-item>
